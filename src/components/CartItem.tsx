...
import { minusItem, plusItem, removeItem } from '../store/slices/cartSlice';
...
export const CartItem: React.FC<CartItemPropsType> = ({ id, title, type, size, price, count, imageUrl }) => {
